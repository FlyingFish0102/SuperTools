 ...
 * @Description:
 * @Company: lxjr.com
 * @Created on 2017-11-21 18:38:50
 */
public class Statistics {
    ...
    public Statistics(int nThread, CountDownLatch startGate, CountDownLatch endGate) {
    ...
    public static void main(String[] args) {
        ...
        new Statistics(nThread, startGate, endGate).timeTasks();
